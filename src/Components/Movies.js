                ...
                >
                  ...
                  >
                    {this.state.hover == movieObj.id && (
                      <a className="btn btn-primary movies-button" onClick={() => this.handleFavorites(movieObj)}>{this.state.favourites.includes(movieObj.id)?"Remove from Favorites" : "Add to Favorites"}</a>
                    )}
                  </div>
                  {/* </div> */}
                </div>
